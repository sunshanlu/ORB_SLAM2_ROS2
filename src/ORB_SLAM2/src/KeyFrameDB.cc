...
void KeyFrameDB::minWordFilter(KfAndWordDB &kfAndWordNum)
{
  ...
  std::for_each(kfAndWordNum.begin(), kfAndWordNum.end(),
                [&](const auto &mpItem) -> void
                {
 ...
 */
void KeyFrameDB::getKfAndWordDB(VirtualFramePtr pFrame, KfAndWordDB &kfAndWordNum, const std::set<KeyFramePtr> &ignoreKfs)
{
 ...
 */
void KeyFrameDB::groupFilter(VirtualFramePtr pFrame, KfAndWordDB &kfAndWordNum, std::vector<KeyFrame::SharedPtr> &candidateKfs)
{

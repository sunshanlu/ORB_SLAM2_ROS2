 ...
 */
cv::Mat LocalMapping::triangulate(KeyFrame::SharedPtr pkf1, KeyFrame::SharedPtr pkf2, const cv::KeyPoint &kp1, const cv::KeyPoint &kp2)
{
 ...
 */
void LocalMapping::findParent(std::set<KeyFrameWeak, KeyFrame::WeakCompareFunc> &spChildren, std::vector<KeyFramePtr> &vpCandidates)
{
